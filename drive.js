AFRAME.registerComponent("drive", {
    init: function() {
        gameStateValue = this.el.getAttribute("game")
    ...
    driveCar: function() {
        ...
        window.addEventListener('keydown', function(e) {
            ...
            if(e.code == "ArrowUp") {
                ...
                if(multiply <= 100 && cameraPosition.z > -500) {
                    ...
                    accelerateCar.setAttribute("material", "color", "lightblue")
            ...
            if(e.code == "Space") {
               ...
               stopCar.setAttribute("material", "color", "brown")
            }
        ...
        window.addEventListener('keyup', function(e) {
            ...
            if(e.code == "Space") {
               ...
               startCar.setAttribute("material", "color", "yellow")
            }
            ...
            if(e.code == "ArrowUp") {
               ...
               var accelerateCar = document.querySelector("#control-acce")
               accelerateCar.setAttribute("material", "color", "purple")
            }
        })
